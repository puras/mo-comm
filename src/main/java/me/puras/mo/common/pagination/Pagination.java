...
public class Pagination {
    ...
    private void buildLinks() {
        ...
        if (currentPage > 0) {
            ...
            if (CONFIG.isShowBlankOfPrevAndNext()) {
                links.add(new Link("上一页", "#"));
            }
        }
    ...
    public static class Config {
        ...
        private boolean showBlankOfPrevAndNext = false;
        ...
        public boolean isShowBlankOfPrevAndNext() {
            return showBlankOfPrevAndNext;
        }

        public void setShowBlankOfPrevAndNext(boolean showBlankOfPrevAndNext) {
            this.showBlankOfPrevAndNext = showBlankOfPrevAndNext;
        }
    }
